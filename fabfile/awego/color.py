# shamelessly stolen and canabalized from portage 
...
compat_functions_colors = ["bold","white","teal","turquoise","darkteal",
		...
		"brown","darkyellow","red","darkred", "darkgray", "lightgray", 
		"underline", "black", "overline", "reverse", "blink", "standout", "faint", 
		"bg_black", "bg_red", "bg_green", "bg_yellow", "bg_blue",
		"bg_purple", "bg_teal", "bg_lightgray"]
...
codes["bg_yellow"]	= codes["bg_brown"]
...
def colors():
	for c in compat_functions_colors:
		cc = getattr(sys.modules['__main__'], c)
		print(cc(c))

	for c in codes:
		print(c)
#	print(red(bg_green(reverse("high"))))
